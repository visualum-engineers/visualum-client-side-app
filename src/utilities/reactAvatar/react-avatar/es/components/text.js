...
var AvatarText = /*#__PURE__*/ (function (_React$PureComponent) {
  ...
  function AvatarText() {
    ...
    _this = _super.call.apply(
      _super,
      _concatInstanceProperty((_context = [this])).call(_context, args)
    );
    ...
    _defineProperty(
      ...
      function (node) {
        ...
        if (textWidth > maxTextWidth)
          spanNode.style.fontSize = "calc(1em * ".concat(
