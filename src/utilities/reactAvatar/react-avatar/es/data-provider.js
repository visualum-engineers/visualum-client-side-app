...
function matchSource(Source, props, cb) {
  ...
  instance.get(function (state) {
    var failedBefore =
      state && state.src && cache.hasSourceFailedBefore(state.src);
...
export default function createAvatarDataProvider(_ref) {
  ...
  var sourcePropTypes = _reduceInstanceProperty(sources).call(
    sources,
    function (r, s) {
      ...
      },
      {
        ...
        value: function render() {
          ...
          return /*#__PURE__*/ React.cloneElement(
            child,
            _defineProperty({}, propertyName, avatarData)
          );
        },
      },
    ]);
